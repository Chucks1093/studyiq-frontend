			...
			<div className="features__second">
				<div className="feature__collaborate">
					<div className="feature__image__container">
						<img
							src="/features/collaboration.jpg"
							alt=""
						/>
					</div>
